        ...
        if(budget==="8~9万円"){
            if(size==="ATX"){
                if(cpu==="Intel"){
                    ...
                    $("#output-cpu").html("CPU")
                    $("#output-a-1").html("i5-10400F")
        
                    var a1 = document.getElementById("output-a-1")
                    a1.href = a3GsjnvC[0]
                    var cpu_price = a3GsjnvC[1]
                }
        ...
        if(budget==="14~16万円"){
            if(size==="ATX"){
                ...
                if(cpu==="AMD"){
                    ...
                    $("#output-cpu").html("CPU")
                    $("#output-a-1").html("Ryzen 5 3600")
        
                    var a1 = document.getElementById("output-a-1")
                    a1.href = a3LQeXj4[0]
                    var cpu_price = a3LQeXj4[1]
                }
